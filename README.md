...
6. Check to see the linked repo on GitHub with command - git remote -v
7. Finally, issue the command - git push -u origin <main/master> depending on the version you are using.
